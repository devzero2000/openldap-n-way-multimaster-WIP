...
echo
echo "=== 4. UN bind SBAGLIATO su $MASTER (per controprova) ==="
ldapsearch -H "ldap://$MASTER/" -D "$TEST_DN" -w "PasswordSbagliataErrata!" -b "$BASE" "(objectClass=*)" || echo "(fallito come atteso)"
